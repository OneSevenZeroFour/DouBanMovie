    ...
    <template v-for="(item,index) in lists">
     <!--  <mu-list-item/> -->
        ...
        <div class='left details'>
          ...
          <div class='year'>{{item.year}}/{{item.casts[0].name_en}}/{{item.genres[0]}}/{{item.genres[1]}}</div>
...
.left{float:left;}
.tenter{width:100%;overflow:hidden;}
...
.anr{height:auto !important;
}
.pingfeng{margin-right:5px;}
.details{margin-left: 30px;margin-top:10px;}
.pingfeng ,.count{color:#ddd !important;font-size:9px !important;}
